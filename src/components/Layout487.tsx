...
const ContentBlock: React.FC<ContentBlockProps & { onVisibilityChange: (isVisible: boolean) => void }> = (props) => {
  ...
  return (
    ...
    >
      ...
      <h2 className='mb-5 text-2xl font-bold md:mb-6 md:text-3xl md:leading-[1.3] lg:text-4xl'>{props.heading}</h2>
