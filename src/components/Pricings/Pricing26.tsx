    ...
    >
      <div>
        ...
        <div className='my-3 md:my-4'>
          <p className='text-2xl font-bold leading-[1.2] sm:text-6xl md:text-9xl lg:text-10xl'>{price}</p>
          <p className='inline-block font-bold'>
            <span>
              {billing === "monthly" ? "Per month" : "Per year"} {billing === "yearly" && <span>({discount})</span>}
            </span>
          </p>
        </div>
        <p>{description}</p>
