...
const PricingPlan = ({ planName, monthlyPrice, description, button, index }: PricingPlan & { index: number }) => {
  return (
    <div
      className={clsx(
    ...
    >
      <div>
        ...
        <div className='my-3 md:my-4'>
          <p className='text-2xl font-bold leading-[1.2] sm:text-6xl md:text-9xl lg:text-10xl'>{monthlyPrice}</p>
        ...
        <div key={index}>
          {featureCategory.title && (
            <div className='border-b border-border-primary py-5'>
              <h3 className='text-md font-bold leading-[1.4] md:text-xl'>{featureCategory.title}</h3>
            </div>
          )}
