    ...
    <section id='relume' className='px-[5%] py-16 md:py-24 lg:py-28'>
      <div className='container'>
        ...
        <div className='flex flex-col justify-start'>
              ...
              {smallFeaturedBlogPosts.map((post, index) => (
                <div key={index} className='grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-[0.5fr_1fr] md:gap-y-4'>
                  <a href={post.url} className='w-full'>
                    <img src={post.image.src} alt={post.image.alt} className='aspect-square w-full object-cover' />
                  </a>
                  <div className='flex h-full flex-col items-start justify-center'>
          ...
          <div className='l grid grid-cols-1 gap-x-12 gap-y-12 md:grid-cols-2 md:gap-y-16'>
            {blogPosts.map((post, index) => (
              <div key={index}>
                ...
                <a href={post.url} className='mb-2 mr-4 inline-block max-w-full text-sm font-semibold'>
                  {post.category}
                </a>
...
export const Blog25Defaults: Blog25Props = {
  tagline: "Blog",
