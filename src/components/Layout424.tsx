...
//     y: useTransform(scrollYProgress, [0.22, 0.44, 0.44, 0.66], ["-100%", "-200%", "-200%", "-300%"]),
//   };
...
//                       style={
//                         [headingOneTransform, headingTwoTransform, headingThreeTransform, headingFourTransform][index]
//                       }
//                     >
//                       {heading}
//                     </motion.h2>
