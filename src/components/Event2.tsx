  ...
  return (
    <section id='relume' className='px-[5%] py-16 md:py-24 lg:py-28'>
      <div className='container'>
        ...
        <Tabs className='flex flex-col justify-start'>
...
const FeaturedEvent: React.FC<FeaturedEvent> = ({ date, url, title, location, status, description, button }) => {
  return (
    <div className='grid grid-cols-1 items-center gap-6 border border-border-primary p-6 sm:px-8 md:grid-cols-[max-content_max-content_1fr_max-content] md:py-8'>
      ...
      <div className='flex w-full flex-col items-start justify-start'>
        <div className='mb-2 flex flex-wrap items-center gap-2 sm:mb-0 sm:gap-4'>
          ...
          {status && <p className='bg-background-secondary px-2 py-1 text-sm font-semibold'>{status}</p>}
        </div>
