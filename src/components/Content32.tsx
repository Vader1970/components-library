...
import { Button, ButtonProps, Input } from "@relume_io/relume-ui";
...
export type Content32Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[0.5fr_1fr] lg:gap-x-20">
          <div className="order-last lg:order-none">
            <div className="lg:sticky lg:top-20 lg:max-w-xxs">
              <div>
                <h6 className="mb-5 font-bold md:mb-6 md:text-md">
                  {contributors.title}
                </h6>
                ...
                <h6 className="mb-3 font-bold md:mb-4 md:text-md">
                  {subscribe.title}
                </h6>
                <form
                  className="mb-4 flex flex-col gap-3 sm:gap-4"
                ...
                <div
                  dangerouslySetInnerHTML={{
                    __html: subscribe.termsAndConditions,
                  }}
                />
                <div className="my-8 h-px bg-border-primary" />
