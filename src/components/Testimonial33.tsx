...
//   return (
//     <section id='relume' ref={sectionRef} className='overflow-hidden px-[5%] py-12 md:py-16 lg:py-20'>
...
//           <div>
//             <h2 className='rb-5 mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl'>{heading}</h2>
...
//             </div>
//           </motion.div>
//           <motion.div className='grid size-full auto-cols-fr grid-cols-1 gap-4' style={{ y: rightCards }}>
