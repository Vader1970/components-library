...
export type Testimonial38Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
...
const BackgroundImageCard = ({
  ...
  <div
    className={clsx(
      ...
      backgroundImageCardCount === 2 &&
        "sm:col-start-2 sm:row-start-2 lg:col-auto lg:row-auto",
      backgroundImageCardCount === 3 &&
        "sm:col-start-1 sm:row-start-5 lg:col-auto lg:row-auto"
    )}
  >
...
const LogoCard = ({
  logo,
  logoCardCount,
}: LogoCardProps & { logoCardCount: number }) => (
  <div
    className={clsx(
      "flex items-center justify-center border border-border-primary p-6 md:p-8 lg:p-6",
      logoCardCount === 3 &&
        "sm:col-start-1 sm:row-start-4 lg:col-auto lg:row-auto"
    )}
  >
