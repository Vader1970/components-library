...
export type Layout527Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
...
const CardBig: React.FC<CardBigProps> = ({
  ...
  <div className="relative flex flex-col justify-center p-6 text-text-alternative sm:min-h-[32rem] md:p-8 lg:p-12">
