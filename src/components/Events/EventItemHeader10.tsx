...
export type EventItemHeader10Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
      ...
      <div className="container">
        <div className="grid grid-cols-1 items-start gap-12 text-text-alternative md:grid-cols-[1.5fr_1fr] lg:gap-20">
          <div className="flex flex-col items-start">
            ...
            <h1 className="mt-8 text-5xl font-bold md:text-7xl lg:text-8xl">
              {heading}
            </h1>
...
export const EventItemHeader10Defaults: Props = {
  ...
  buttons: [
    { title: "Save my spot" },
    { title: "View event", variant: "secondary-alt" },
  ],
  date: {
    weekday: "Sat",
    day: "10",
