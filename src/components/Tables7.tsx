...
export type Table7Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
...
const ExpandedContent = ({
  ...
  details: DetailedTableData["details"];
}) => (
  <div className="grid flex-1 auto-cols-fr grid-cols-5 items-start bg-background-secondary py-8 pl-8 pr-0">
    <div className="flex flex-col items-start gap-4 px-6">
      <DetailRow
        label={details.dateJoined.label}
        value={details.dateJoined.value}
      />
    ...
    <div className="flex flex-col items-start gap-4 px-6">
      ...
      <DetailRow
        label={details.experience.label}
        value={details.experience.value}
      />
    </div>
