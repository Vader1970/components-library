          ...
          {isMobile ? (
            <Sheet>
              ...
              <SheetPortal>
                ...
                <SheetContent side='left' className='w-[80vw] overflow-hidden md:w-full md:max-w-[19.5rem]'>
                  <Navigation />
                </SheetContent>
              </SheetPortal>
            </Sheet>
        ...
        <div className='sticky top-0 flex h-auto min-h-16 w-full items-center border-b border-border-primary bg-white px-6 md:min-h-18 lg:px-8'>
          <div className='mx-auto grid size-full grid-cols-1 items-center justify-end justify-items-end gap-4 lg:grid-cols-[1fr_max-content] lg:justify-between lg:justify-items-stretch'>
            ...
            <div className='flex items-center gap-2 md:gap-4'>
              <button onClick={() => setIsSearchIconClicked(!isSearchIconClicked)} className='p-2 lg:hidden'>
              ...
              <AnimatePresence>
                {isSearchIconClicked && (
                  ...
                  >
                    <Input className='h-fit w-full' placeholder='Search' icon={<BiSearch className='size-6' />} />
              ...
              <DropdownMenu onOpenChange={(isDropdownOpen) => setIsDropdownOpen(isDropdownOpen)}>
                ...
                <DropdownMenuContent align='end' sideOffset={0} className='mt-1.5 min-w-32 px-0 py-2 md:min-w-48'>
                  <DropdownMenuGroup>
                    <DropdownMenuItem>
                      <a href='#'>My Profile</a>
                    </DropdownMenuItem>
          ...
          <Accordion type='single' collapsible>
            <AccordionItem value='item-1' className='border-none'>
              <AccordionTrigger
                ...
                icon={<RxChevronDown className='shrink-0 text-text-primary transition-transform duration-300' />}
              >
