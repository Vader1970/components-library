...
export const Layout421 = (props: Layout421Props) => {
  ...
  const containerOpacity = useTransform(scrollY, [0, halfViewportHeight], [1, 0]);
  const containerScale = useTransform(scrollY, [0, halfViewportHeight], [1, 0.95]);

  // Precompute image transforms
  const imageTransforms = [
    // Image 1
    {
      translateX: useTransform(scrollYProgress, [0, 1], isMobile ? ["13%", "90%"] : ["0%", "100%"]),
      translateY: useTransform(scrollYProgress, [0, 1], isMobile ? ["12%", "80%"] : ["0%", "60%"]),
      rotateZ: useTransform(scrollYProgress, [0, 1], isMobile ? ["0.6deg", "4deg"] : ["0deg", "-4deg"]),
    },
    // Image 2
    {
      translateX: useTransform(scrollYProgress, [0, 1], isMobile ? ["-12%", "-80%"] : ["0%", "-50%"]),
      translateY: useTransform(scrollYProgress, [0, 1], isMobile ? ["-12%", "-80%"] : ["0%", "-90%"]),
      rotateZ: useTransform(scrollYProgress, [0, 1], isMobile ? ["-3deg", "4deg"] : ["4deg", "4deg"]),
    },
    // Image 3
    {
      translateX: useTransform(scrollYProgress, [0, 1], isMobile ? ["17.5%", "120%"] : ["0%", "140%"]),
      translateY: useTransform(scrollYProgress, [0, 1], isMobile ? ["-6%", "-40%"] : ["0%", "-40%"]),
      rotateZ: useTransform(scrollYProgress, [0, 1], isMobile ? ["-0.6deg", "-6deg"] : ["0deg", "-12deg"]),
    },
    // Image 4
    {
      translateX: useTransform(scrollYProgress, [0, 1], isMobile ? ["-17.5%", "-120%"] : ["0%", "-140%"]),
      translateY: useTransform(scrollYProgress, [0, 1], isMobile ? ["9%", "60%"] : ["0%", "60%"]),
      rotateZ: useTransform(scrollYProgress, [0, 1], isMobile ? ["4.6deg", "8deg"] : ["8deg", "8deg"]),
    },
  ];
