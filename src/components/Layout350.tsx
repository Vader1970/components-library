...
// type AllowedVariants = ButtonProps["variant"]; // Inspect the allowed values
...
type Section = {
  ...
  heading: string;
  description: string;
  buttons: ButtonProps[]; // Ensures all buttons are fully typed
};
...
export type Layout350Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
...
export const Layout350Defaults = {
  sections: [
    {
      ...
      ] as ButtonProps[], // Explicitly cast to ButtonProps[],
    },
    {
      id: "Content-Block-2",
  ...
  ] as Section[], // Cast entire array to Section[],
};
