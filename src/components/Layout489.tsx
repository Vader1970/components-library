...
export type Layout489Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
            ...
            <Tabs defaultValue={defaultTabValue}>
              ...
              {tabs.map((tab, index) => (
                <TabsContent
                  key={index}
                  value={tab.value}
                  className="data-[state=active]:animate-tabs relative bottom-0 right-0 top-0 flex size-full items-center justify-center md:absolute md:w-1/2 md:pl-6 lg:pl-10"
                >
                  {tab.image && (
                    <img
                      src={tab.image.src}
