...
export type Gallery17Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
...
export const Gallery17 = (props: Gallery17Props) => {
  ...
  return (
    <section>
      <div className="overflow-hidden px-[5%] py-16 md:py-24 lg:py-28">
            ...
            <div className="relative">
              <CarouselContent className="ml-0">
                {images.map((image, index) => (
                  <CarouselItem
                    key={index}
                    className="px-3 md:basis-1/2 md:px-4"
                  >
