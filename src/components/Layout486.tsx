...
export const Layout486 = (props: Layout486Props) => {
  ...
  const y = isTablet
    ? useTransform(scrollYProgress, [0.3, 0.4, 0.5, 0.6, 0.7, 0.8], ["0%", "-25%", "-25%", "-50%", "-50%", "-75%"])
    : useTransform(scrollYProgress, [0.3, 0.4, 0.5, 0.6, 0.7, 0.8], ["0%", "0%", "-25%", "-35%", "-50%", "-75%"]);
...
const FeatureCard = ({ ...feature }: Feature) => {
  ...
  return (
    <div className='flex flex-col items-start justify-center py-8 md:py-0'>
      ...
      <h2 className='rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl'>{feature.heading}</h2>
