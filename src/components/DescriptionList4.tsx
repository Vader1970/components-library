...
export type DescriptionList4Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
...
export const DescriptionList4 = (props: DescriptionList4Props) => {
  ...
  return (
    <section id="relume" className="border border-border-primary p-8">
      <div className="pb-5 md:pb-6">
        <h1 className="text-lg font-bold leading-[1.4] md:text-2xl">
          {sectionTitle}
        </h1>
...
export const DescriptionList4Defaults: Props = {
  ...
  listItems: [
    ...
    { title: "Website", content: "www.company.com", linkText: "Change" },
    {
      title: "About",
      content:
    ...
    { title: "Email address", content: "hello@email.io", linkText: "Change" },
