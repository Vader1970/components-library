...
export type Form15Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
...
export const Form15 = (props: Form15Props) => {
  ...
  const [emailAnnouncements, setEmailAnnouncements] = useState<
    boolean | "indeterminate"
  >(false);
  const [emailSupport, setEmailSupport] = useState<boolean | "indeterminate">(
    false
  );
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="grid auto-cols-fr grid-cols-1 gap-6"
      >
        <div>
