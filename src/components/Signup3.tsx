...
export type Signup3Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
      ...
      <div className="mx-auto w-full max-w-sm border border-border-primary px-6 py-8 sm:px-8 md:p-12">
        ...
        <form className="grid grid-cols-1 gap-6" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1">
            <Label htmlFor="name3" className="mb-2">
              Name*
            </Label>
            <Input
              type="text"
          ...
          <div className="grid grid-cols-1">
            <Label htmlFor="email3" className="mb-2">
              Email*
            </Label>
            <Input
              type="email"
          ...
          <div className="grid grid-cols-1">
            <Label htmlFor="password3" className="mb-2">
              Password*
            </Label>
            <Input
              type="password"
