...
export const Header108 = (props: Header108Props) => {
  ...
  const leftImageGroupX = useTransform(scrollYProgress, [0, 1], isMobile ? ["0vw", "-25vw"] : ["0vw", "-32vw"]);

  const centerImageX = useTransform(scrollYProgress, [0, 1], isMobile ? ["0vw", "-25vw"] : ["0vw", "-32vw"]);

  const centerImageWidth = useTransform(scrollYProgress, [0, 1], isMobile ? ["50vw", "100vw"] : ["36vw", "100vw"]);

  const centerImageHeight = useTransform(scrollYProgress, [0, 1], isMobile ? ["60vh", "100vh"] : ["80vh", "100vh"]);

  const rightImageGroupX = useTransform(scrollYProgress, [0, 1], isMobile ? ["0vw", "25vw"] : ["0vw", "32vw"]);
