...
//   const leftHeadingTranslate = {
//     x: useTransform(scrollYProgress, [0, 0.6], ["10rem", "0rem"]),
//   };
//   const rightHeadingTranslate = {
//     x: useTransform(scrollYProgress, [0, 0.6], ["-10rem", "0rem"]),
//   };
...
//   const overlayMotion = {
//     width: useTransform(scrollYProgress, [0.6, 1], isMobile ? ["10vw", "250vw"] : ["10vw", "200vw"]),
//     height: useTransform(scrollYProgress, [0.6, 1], isMobile ? ["10vw", "250vw"] : ["10vw", "200vw"]),
//   };
...
//           >
//             <img src={image.src} alt={image.alt} className='aspect-square size-full rounded-full object-cover' />
//             <motion.div className='absolute -z-10 rounded-full bg-neutral-lightest' style={overlayMotion} />
//           </motion.div>
//           <motion.h2
