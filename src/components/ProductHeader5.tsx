...
export const ProductHeader5 = (props: ProductHeader5Props) => {
  const { breadcrumbs, heading, price, description, rating, buttons, guarantee, questions, image, video, features } = {
      ...
      <div className='container'>
        <div className='grid grid-cols-1 gap-y-12 md:gap-y-16 lg:grid-cols-[1.25fr_0.5fr] lg:gap-x-20'>
          <div>
            ...
            <h1 className='mb-3 text-4xl font-bold leading-[1.2] md:mb-4 md:text-5xl lg:text-6xl'>{heading}</h1>
